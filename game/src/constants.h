...
extern long long			exp_table_common[PLAYER_EXP_TABLE_MAX + 1];
extern const long long*		exp_table;

extern long long		guild_exp_table[GUILD_MAX_LEVEL + 1];
extern long long		guild_exp_table2[GUILD_MAX_LEVEL + 1];
