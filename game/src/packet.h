...
enum
{
	...
	HEADER_GC_SAFEBOX_MONEY_CHANGE              = 66,	/*** Only Client ***/
	...
	HEADER_GC_REFINE_INFORMATION_OLD			= 75,
	...
	HEADER_GG_BLOCK_EXCEPTION					= 23,
	HEADER_GG_SIEGE								= 24,
	HEADER_GG_MONARCH_NOTICE					= 25,
	HEADER_GG_MONARCH_TRANSFER					= 26,
	HEADER_GG_CHECK_AWAKENESS					= 27,
	HEADER_GG_BIG_NOTICE						= 28,
};
